...
## 🚀 **Featured Application: Kasia Direct Messenger**
...
- **💰 Micro-Transactions**: Send messages for as little as 0.00001 KAS (20,000x cheaper than KasWare!)
- **🌐 Universal Compatibility**: Works in any modern browser
- **🔒 End-to-End Encryption**: Private keys never leave your device
- **💬 Real Conversations**: Persistent conversation history and management
...
### 🎯 **How to Use**
1. **Access**: Click ⚡ Kasia Direct icon on desktop
...
#### Usage
- **Toggle Debug Mode**: Settings → Debug & Error Reporting → Enable Debug Mode
- **View Console**: Press `Ctrl+Shift+D` or use manual buttons in Settings panel NEEDS ATTENTION!!
- **Manual Controls**: If keyboard shortcuts don't work, use Settings → "Toggle Debug Panel" button
...
#### 1. Kasia Direct Messenger (⚡) **REVOLUTIONARY!**
...
2. **Files won't save**: Ensure sufficient browser storage space (use Settings → Storage Management)
...
5. **Storage quota exceeded**: Use Settings → Request Storage Increase or clear error logs
...
- **Error Export**: Use Settings → Export Error Log to save debugging information
- **Storage Cleanup**: Use Settings → Clear Errors to free up storage space
